            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="single-product">
                    <div class="product-image">
                        ...
                        <div class="button">
                            <a href="{{ route('cart.add.get', $product->id) }}" class="btn">
                    ...
                    <div class="product-info">
                        <span class="category">
                            @if($product->category && $product->category->image)
                                <img src="{{ url('/categories/' . $product->category->image) }}" alt="{{ $product->category->name }}" style="width:20px; height:20px; margin-right:5px; border-radius:4px;">
                            @endif
